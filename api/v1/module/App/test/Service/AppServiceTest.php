...
class AppServiceTest extends AbstractServiceTest
{
    ...
    public function testProcessEntity()
    {
        ...
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'entity' => array(array( 'name' => 'Individual Professional Liability', 'field' => array(array('name' => 'policyStatus', 'text' => 'Policy Status', 'data_type' => 'text')))));
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'entity' => '');
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
        $content = $appService->processEntity($data);
        $sqlQuery = "SELECT count(name) as count FROM ox_app_entity WHERE app_id = 299";
        $adapter = $this->getDbAdapter();
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')));
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
        $content = $appService->processEntity($data);
        $sqlQuery = "SELECT count(name) as count FROM ox_app_entity WHERE app_id = 299";
        $adapter = $this->getDbAdapter();
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'form' => array(array('name' => 'PADI Verification', 'uuid' => 'd2ed4200-9131-4671-b0e0-de3e27c3f610', 'description' => 'Page for CSR to verify PADI details', 'template_file' => 'dummypage.json','entity' => 'Padi')));        
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'workflow' =>array(array('name' => 'Dive Boat Reinstate Policy', 'entity' => 'Dive Boat', 'uuid' => '2d94a2f0-c64c-48e0-a4f0-f85f626f0626', 'bpmn_file' => 'Cancel Policy/ReinstatePolicyDB.bpmn')));        
        $path = __DIR__ . '/../sampleapp/';
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')),'org' => array(array( 'uuid' => 'a77ea120-b028-479b-8c6e-60476b6a4456')), 'menu' => array(array('name' => 'Home', 'icon' => 'fa fa-home', 'uuid' => '24176975-8f4d-499d-8b2d-86902de26c14', 'page_uuid' => 'b9714cfd-2ae5-4f13-83eb-7d925c3b660c')));
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
        $path = __DIR__ . '/../sampleapp/';
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')),'org' => array(array( 'uuid' => 'a77ea120-b028-479b-8c6e-60476b6a4456')));
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
        $path = __DIR__ . '/../sampleapp/';
        $content = $appService->processMenu($data, $path);
        $sqlQuery = "SELECT count(name) as count FROM ox_app_menu WHERE app_id = 299 and name = 'Home'";
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'org' => array(array( 'uuid' => 'a77ea120-b028-479b-8c6e-60476b6a4456')), 'pages' => array(array('page_name' => 'dummyPage.yml', 'uuid' => 'b9714cfd-2ae5-4f13-83eb-7d925c3b660c')));        
        $path = __DIR__ . '/../sampleapp/';
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
    ...
    public function testProcessJob()
    {
        ...
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'org' => array(array( 'uuid' => 'a77ea120-b028-479b-8c6e-60476b6a4456')), 'job' =>array(array('uuid' => '129dfbe2-151d-49c8-81e9-a4b7582df65e', 'name' => 'autoRenewalJob', 'url' => '/workflow/f0efea9e-7863-4368-a9b2-baa1a1603067', 'cron' => '0 4 12 18 * ? 2020', 'data' => array('EFR2M' => '204','padi' => '2165', 'padiVerified' => '1'))));
        if (enableCamel == 0) {
    ...
    public function testCreateRole()
    {
        ...
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'org' => array(array( 'uuid' => 'a77ea120-b028-479b-8c6e-60476b6a4456')), 'role' => array(array('name' => 'Policy Holder', 'default' => '1', 'privileges' => array(array('privilege_name' => 'MANAGE_MY_POLICY', 'permission' => '3')),'uuid' => '703d3a09-b7f3-49e9-9c79-74d5cae7f6e7')));
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
    ...
    {
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459', 'name' => 'SampleApp2', 'description' => 'test db for app service test')));        
        $path = __DIR__ . '/../sampleapp';
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
        $content = $appService->performMigration($data, $path);
        $result = true;
        $appName = 'SampleApp2';
        $YmlappUuid = 'f77ea120-b028-479b-8c6e-60476b6a4459';
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459')), 'privilege' => array(array('name' => 'MANAGE_POLICY_APPROVAL', 'permission' => 3)));
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459', 'name' => 'DummyApp')));        
        $path = __DIR__ . '/../sampleapp/';
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
    ...
    {
        AuthContext::put(AuthConstants::USER_ID, '1');
        $data = array('app' => array(array( 'uuid' => 'f77ea120-b028-479b-8c6e-60476b6a4459', 'name' => 'DummyApp')), 'org' => array(array('uuid' => 'a77ea120-b028-479b-8c6e-60476b6a4456')));        
        $path = __DIR__ . '/../sampleapp/';
        $appService = $this->getApplicationServiceLocator()->get(AppService::class);
        $content = $appService->processSymlinks($data, $path);
        $config = $this->getApplicationConfig();
        $delegatefolder = $config['DELEGATE_FOLDER']. 'f77ea120-b028-479b-8c6e-60476b6a4459' ;
        $result = file_exists($delegatefolder);
        $this->assertEquals($result, 1);
        $formfolder = $config['FORM_FOLDER']. 'f77ea120-b028-479b-8c6e-60476b6a4459' ;
