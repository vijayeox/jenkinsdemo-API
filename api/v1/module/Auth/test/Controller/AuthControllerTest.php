...
class AuthControllerTest extends ControllerTest
{
    ...
    public function testRegister()
    {
        ...
        $this->assertArrayHasKey('credentials',$content['data']);
    ...
    {
        $data = '{"data":{"firstname":"Bharat","lastname":"Gogineni","address1":"66,1st cross,2nd main,H.A.L 3r","address2":"PES University Campus,","city":"Bangalore","zip":"560075","state":"AR","country":"India","sameasmailingaddress":false,"address3":"Bangalore","address4":"PES University Campus,","phonenumber":"(973) 959-1462","mobilephone":"(973) 959-1462","fax":"","email":"bharatgoku@gmail.com","submit":true},"metadata":{"timezone":"Asia/Calcutta","offset":330,"referrer":"","browserName":"Netscape","userAgent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36","pathName":"/static/1/","onLine":true},"state":"submitted","saved":false,"orgId":"53012471-2863-4949-afb1-e69b0891c98a","commands":["create_user","store_cache_data"]}';
        $this->dispatch('/register', 'POST', json_decode($data,true));
        $content = (array)json_decode($this->getResponse()->getContent(), true);
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('auth');
        ...
        $this->assertEquals($content['status'], 'success');
        $this->assertArrayHasKey('data',$content['data']);
        $this->assertArrayNotHasKey('credentials',$content['data']);
    }
    public function testRegisterWithoutCacheCommand()
    {
        $data = '{"data":{"firstname":"Bharat","lastname":"Gogineni","address1":"66,1st cross,2nd main,H.A.L 3r","address2":"PES University Campus,","city":"Bangalore","zip":"560075","state":"AR","country":"India","sameasmailingaddress":false,"address3":"Bangalore","address4":"PES University Campus,","phonenumber":"(973) 959-1462","mobilephone":"(973) 959-1462","fax":"","email":"bharatgoku@gmail.com","submit":true},"metadata":{"timezone":"Asia/Calcutta","offset":330,"referrer":"","browserName":"Netscape","userAgent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36","pathName":"/static/1/","onLine":true},"state":"submitted","saved":false,"orgId":"53012471-2863-4949-afb1-e69b0891c98a","commands":["create_user"]}';
        $this->dispatch('/register', 'POST', json_decode($data,true));
        $content = (array)json_decode($this->getResponse()->getContent(), true);
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('auth');
    ...
    {
        $data = '{"data":{"username":"bharatgtest"},"username":"bharatgtest","dummdata":"dummy","commands":["store_cache_data"]}';
        $this->dispatch('/register', 'POST', json_decode($data,true));
        $content = (array)json_decode($this->getResponse()->getContent(), true);
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('auth');
    ...
    {
        $data = '{"data":{"username":"bharatgtest"},"username":"goku","dummdata":"dummy","commands":["store_cache_data"]}';
        $this->dispatch('/register', 'POST', json_decode($data,true));
        $content = (array)json_decode($this->getResponse()->getContent(), true);
        $this->assertResponseStatusCode(404);
        $this->assertModuleName('auth');
    ...
    public function testRegisterUserExists()
    {
        ...
        $this->assertResponseHeaderContains('content-type', 'application/json; charset=utf-8');
        $this->assertEquals($content['status'], 'error');
        $this->assertEquals($content['message'], 'Error Creating User');
    }
}
