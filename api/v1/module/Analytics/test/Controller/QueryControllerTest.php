...
class QueryControllerTest extends ControllerTest
{
    ...
    public function testQueryData()
    {
        if (enableElastic!=0) {
            ...
            $input = json_decode('{"index":"'.$this->index_pre.'sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field6"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":1000},"aggs":{"value":{"avg":{"field":"field6"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}',true);
    ...
    public function testQueryDataWithAggregateFollowedByNonAggregate()
    {
        if (enableElastic!=0) {
            ...
            $input1 = json_decode('{"index":"'.$this->index_pre.'sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field5"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":1000},"aggs":{"value":{"avg":{"field":"field5"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}{"index":"core_sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field6"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":10000},"aggs":{"value":{"avg":{"field":"field6"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}',true);
            $output1 = json_decode('{"took":378,"timed_out":false,"_shards":{"total":1,"successful":1,"skipped":0,"failed":0},"hits":{"total":{"value":3,"relation":"eq"},"max_score":null,"hits":[]},"aggregations":{"groupdata":{"doc_count_error_upper_bound":0,"sum_other_doc_count":0,"buckets":[{"key":"cfield3text","doc_count":2,"value":{"value":35}},{"key":"cfield5text","doc_count":1,"value":{"value":40}}]}}}',true);
            $input2 = json_decode('{"index":"core_sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field5"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":1000},"aggs":{"value":{"avg":{"field":"field5"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}',true);
