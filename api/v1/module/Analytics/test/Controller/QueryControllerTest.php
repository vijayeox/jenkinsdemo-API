...
class QueryControllerTest extends ControllerTest
{
    ...
    public function testQueryData()
    {
        if (enableElastic != 0) {
            ...
            $input1 = json_decode('{"index":"' . $this->index_pre . 'sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field5"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":65535},"aggs":{"value":{"avg":{"field":"field5"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}', true);
            ...
            $input = json_decode('{"index":"' . $this->index_pre . 'sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field6"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":65535},"aggs":{"value":{"avg":{"field":"field6"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}', true);
    ...
    public function testQueryDataWithAggregateFollowedByNonAggregate()
    {
        if (enableElastic != 0) {
            ...
            $input1 = json_decode('{"index":"' . $this->index_pre . 'sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field5"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":65535},"aggs":{"value":{"avg":{"field":"field5"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}{"index":"core_sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field6"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":500000},"aggs":{"value":{"avg":{"field":"field6"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}', true);
            $output1 = json_decode('{"took":378,"timed_out":false,"_shards":{"total":1,"successful":1,"skipped":0,"failed":0},"hits":{"total":{"value":3,"relation":"eq"},"max_score":null,"hits":[]},"aggregations":{"groupdata":{"doc_count_error_upper_bound":0,"sum_other_doc_count":0,"buckets":[{"key":"cfield3text","doc_count":2,"value":{"value":35}},{"key":"cfield5text","doc_count":1,"value":{"value":40}}]}}}', true);
            $input2 = json_decode('{"index":"core_sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field5"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":65535},"aggs":{"value":{"avg":{"field":"field5"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}', true);
    ...
    public function testQueryDataWithNonAggregateFollowedByAggregate()
    {
        if (enableElastic != 0) {
            ...
            $this->markTestSkipped('Only Integration Test');
            $input1 = json_decode('{"index":"' . $this->index_pre . 'sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"field5"}}]}},"_source":["*","field3"],"aggs":{"groupdata":{"terms":{"field":"field3.keyword","size":1000},"aggs":{"value":{"avg":{"field":"field5"}}}}},"explain":true},"_source":["*","field3"],"from":0,"size":0}', true);
            $output1 = json_decode('{"took":378,"timed_out":false,"_shards":{"total":1,"successful":1,"skipped":0,"failed":0},"hits":{"total":{"value":3,"relation":"eq"},"max_score":null,"hits":[]},"aggregations":{"groupdata":{"doc_count_error_upper_bound":0,"sum_other_doc_count":0,"buckets":[{"key":"cfield3text","doc_count":2,"value":{"value":35}},{"key":"cfield5text","doc_count":1,"value":{"value":40}}]}}}', true);
            $input2 = json_decode('{"index":"core_sampleapp_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"range":{"workflow_instance_date_created":{"gte":"2018-01-01","lte":"2019-12-12","format":"yyyy-MM-dd"}}}]}},"_source":["form_name"],"explain":true},"_source":["form_name"],"from":0,"size":500000}', true);
            $output2 = json_decode('{"took":1,"timed_out":false,"_shards":{"total":1,"successful":1,"skipped":0,"failed":0},"hits":{"total":{"value":3,"relation":"eq"},"max_score":2,"hits":[{"_shard":"[core_sampleapp_index][0]","_node":"pWx1rFYMTh29mVYvAj_Rbw","_index":"core_sampleapp_index","_type":"_doc","_id":"8","_score":2,"_source":{"form_name":"Test Form 2"},"_explanation":{"value":2,"description":"sum of:","details":[{"value":1,"description":"account_id:[1 TO 1]","details":[]},{"value":1,"description":"ConstantScore(DocValuesFieldExistsQuery [field=workflow_instance_date_created])","details":[]}]}},{"_shard":"[core_sampleapp_index][0]","_node":"pWx1rFYMTh29mVYvAj_Rbw","_index":"core_sampleapp_index","_type":"_doc","_id":"9","_score":2,"_source":{"form_name":"Test Form 3"},"_explanation":{"value":2,"description":"sum of:","details":[{"value":1,"description":"account_id:[1 TO 1]","details":[]},{"value":1,"description":"ConstantScore(DocValuesFieldExistsQuery [field=workflow_instance_date_created])","details":[]}]}},{"_shard":"[core_sampleapp_index][0]","_node":"pWx1rFYMTh29mVYvAj_Rbw","_index":"core_sampleapp_index","_type":"_doc","_id":"10","_score":2,"_source":{"form_name":"Test Form 4"},"_explanation":{"value":2,"description":"sum of:","details":[{"value":1,"description":"account_id:[1 TO 1]","details":[]},{"value":1,"description":"ConstantScore(DocValuesFieldExistsQuery [field=workflow_instance_date_created])","details":[]}]}}]}}', true);
            $clientMock = Mockery::mock('Elasticsearch\Client');
            $this->elasticService->setElasticClient($clientMock);
            $indexMock = Mockery::mock('Elasticsearch\Namespaces\IndicesNamespace');
