...
class WorkflowInstanceControllerTest extends ControllerTest
{
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals($fileAttributeCount + 6, $this->getConnection()->getRowCount('ox_file_attribute'));
...
//-----------
    public function testGetListOfFilesWithUserIdUsingMultipleFilters()
    {
        ...
        $this->dispatch('/app/9fc99df0-d91b-11e9-8a34-2a2ae2dbcce4/workflow/1141cd2e-cb14-11e9-a32f-2a2ae2dbcce4/4fd99e8e-758f-11e9-b2d5-68ecc57cde45/file?filter=[{"filter":{"filters":[{"field":"expiry_date","operator":"lt","value":"' . $currentDate . '"}, {"field":"field1","operator":"eq","value":1}]},"sort":[{"field":"expiry_date","dir":"asc"}],"skip":0,"take":1}]', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('Workflow');
        $this->assertControllerName(WorkflowInstanceController::class);
        $this->assertControllerClass('WorkflowInstanceController');
    ...
    {
        $this->initAuthToken($this->adminUser);
        $this->dispatch('/app/9fc99df0-d91b-11e9-8a34-2a2ae2dbcce4/workflowinstance/1/activityinstance/3f6622fd-0124-11ea-a8a0-22e8105c0778/form', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('Workflow');
        $this->assertControllerName(WorkflowInstanceController::class); // as specified in router's controller name alias
        $this->assertControllerClass('WorkflowInstanceController');
