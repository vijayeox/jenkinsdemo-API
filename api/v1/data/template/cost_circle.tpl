<div class="oxzion-widget-content">
    ...
    {if $resultratio<0.35} {$color='#f7614f' } {$Fontcolor='#f1230b' }{*lightred*} {elseif $resultratio<.70} {$color='#f3412c' } {$Fontcolor='#f1230b' }{*mediumred*} {else} {$color='#f1230b' } {$Fontcolor='#f1230b' }{*darkred*} {/if} <svg height="150" width="150">
