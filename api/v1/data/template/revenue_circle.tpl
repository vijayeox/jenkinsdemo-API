<div class="oxzion-widget-content">
  ...
  {if $resultratio<0.35} {$color='#f1230b'} {$Fontcolor='#f1230b'} {*Red*} {elseif $resultratio<.70} {$color = 'yellow'} {$Fontcolor='#d6c319'} {*Yellow*} {else} {$color='royalblue'} {$Fontcolor='mediumblue'} {*blue*} {/if} <svg height="150" width="150">
