...
final class Version20190430101311 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
    	...
    	$this->addSql("INSERT INTO `ox_role_privilege` (`role_id`,`privilege_name`,`permission`,`org_id`,`app_id`) SELECT 1,'MANAGE_EMAIL',1,1, id from ox_app WHERE name LIKE 'MailAdmin'");
    ...
    public function down(Schema $schema) : void
    {
    	...
    	$this->addSql("INSERT INTO `ox_role_privilege` (`role_id`,`privilege_name`,`permission`,`org_id`,`app_id`) SELECT 2,'MANAGE_EMAIL',1,1,id from ox_app WHERE name LIKE 'MailAdmin'");
    	$this->addSql("INSERT INTO `ox_role_privilege` (`role_id`,`privilege_name`,`permission`,`org_id`,`app_id`) SELECT 3,'MANAGE_EMAIL',1,1,id from ox_app WHERE name LIKE 'MailAdmin'");
