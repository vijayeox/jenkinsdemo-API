 ...
 */
final class Version20210331114221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        and oxrp.privilege_name = 'MANAGE_USER'
        ...
        if(count($result)>0){
            foreach($result as $row){
                ...
                $this->addSql("INSERT INTO `ox_role_privilege` (`role_id`,`privilege_name`,`permission`,`account_id`,`app_id`) SELECT ".$row['role_id'].",'MANAGE_USER',15,".$accountId .",id from ox_app WHERE name LIKE 'Admin';");
            }
        }
