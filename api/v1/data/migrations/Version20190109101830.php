...
final class Version20190109101830 extends AbstractMigration
{
    ...
    {
        $this->addSql("CREATE TABLE `ox_workflow` ( `id` INT(32) NOT NULL AUTO_INCREMENT , `name` INT(32) NOT NULL , `process_ids` TEXT NOT NULL , `app_id` INT(32) NOT NULL , `form_id` TEXT NOT NULL , `process_keys` TEXT NOT NULL , `org_id` int(11) NOT NULL, `created_by` INT(32) NOT NULL DEFAULT '1', `modified_by` INT(32) , `date_created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ,
