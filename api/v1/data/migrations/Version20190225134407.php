...
//        $this->addSql("UPDATE `ox_role_privilege` SET `app_id`='$uniqueIdString',org_id = 1 WHERE `privilege_name` LIKE 'MANAGE_APP' AND `role_id` = 1");
        ...
        $this->addSql("INSERT INTO `ox_app` (name,category,uuid,type) VALUES ('Announcement','EXAMPLE_CATEGORY','".Uuid::uuid4()->getHex()."',2);");
        $this->addSql("INSERT INTO `ox_app` (name,category,uuid,type) VALUES ('App Builder','EXAMPLE_CATEGORY','".Uuid::uuid4()->getHex()."',2);");
        $this->addSql("INSERT INTO `ox_app` (name,category,uuid,type) VALUES ('User','EXAMPLE_CATEGORY','".Uuid::uuid4()->getHex()."',2);");
        $this->addSql("INSERT INTO `ox_app` (name,category,uuid,type) VALUES ('Project','EXAMPLE_CATEGORY','".Uuid::uuid4()->getHex()."',2);");
        $this->addSql("INSERT INTO `ox_app` (name,category,uuid,type) VALUES ('Group','EXAMPLE_CATEGORY','".Uuid::uuid4()->getHex()."',2);");
        $this->addSql("INSERT INTO `ox_app` (name,category,uuid,type) VALUES ('Role','EXAMPLE_CATEGORY','".Uuid::uuid4()->getHex()."',2);");
        $this->addSql("INSERT INTO `ox_app` (name,category,uuid,type) VALUES ('Organization','EXAMPLE_CATEGORY','".Uuid::uuid4()->getHex()."',2);");
    }
