...
final class Version20190423091630 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("UPDATE `ox_app` SET `category` = NULL, `name` = 'Announcements',`type` = 1 WHERE `id` = 2");
        $this->addSql("UPDATE `ox_app` SET `name`= 'AppBuilder',`type` = 1 WHERE `id` = 3");
        $this->addSql("INSERT INTO `ox_app` (`name`,`uuid`,`category`,`date_created`,`created_by`,`status`,`start_options`) VALUES ('CRM','".Uuid::uuid4()->getHex()."','organization','2019-04-25 04:11:39',1,4,'{\"autostart\":\"false\",\"hidden\":\"false\"}')");
        $this->addSql("INSERT INTO `ox_app` (`name`,`uuid`,`category`,`date_created`,`created_by`,`status`,`start_options`) VALUES ('MailAdmin','".Uuid::uuid4()->getHex()."','utilities','2019-04-25 04:11:39',1,4,'{\"autostart\":\"false\",\"hidden\":\"false\"}')");
