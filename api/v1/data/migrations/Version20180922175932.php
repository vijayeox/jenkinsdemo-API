...
final class Version20180922175932 extends AbstractMigration
{
	public function up(Schema $schema) : void
	{
		...
		$this->addSql("ALTER TABLE `ox_role_privelege` ADD UNIQUE `role_privelege` (`role_name`, `privelege_id`);");

		$this->addSql("ALTER TABLE `ox_role_user` ADD UNIQUE `role_user` (`user_id`, `role_id`);");
