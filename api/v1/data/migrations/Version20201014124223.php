...
final class Version20201014124223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO ox_role_privilege (role_id,privilege_name,permission, org_id, app_id) values (4, 'MANAGE_APPLICATION',3, 1, 1);");
        $this->addSql("INSERT INTO ox_role_privilege (role_id,privilege_name,permission, org_id, app_id) values (6, 'MANAGE_INSTALL_APP',3, 1, 1);");
