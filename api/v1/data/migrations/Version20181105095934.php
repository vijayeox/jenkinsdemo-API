...
final class Version20181105095934 extends AbstractMigration
{
	public function up(Schema $schema) : void
	{
		...
		$this->addSql("CREATE TABLE IF NOT EXISTS `ox_user_group` (
			...
			SELECT * FROM ox_user_group;");
		$this->addSql("INSERT INTO ox_privilege (name,permission_allowed) values ('MANAGE_GROUP',15);");
		$this->addSql("INSERT INTO ox_role_privilege (role_id,privilege_name,permission) values (1, 'MANAGE_GROUP',15);");
