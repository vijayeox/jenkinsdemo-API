...
SELECT `of`.uuid, `of`.start_date,`of`.end_Date,`of`.`rygStatus`,`of`.Title, `oxu`.uuid as `assigneeId`, `oxu`.username as `assigneeUser`, `cu`.uuid as `createdUserId`, `cu`.username as `createdUser`
From ox_file `of`
