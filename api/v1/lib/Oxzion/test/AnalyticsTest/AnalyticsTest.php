...
class AnalyticsTest extends MainControllerTest
{
    ...
    //         $input = '{"index":"core_11_test_index","body":{"query":{"bool":{"must":[{"term":{"account_id":1}},{"exists":{"field":"amount"}},{"bool":{"must":[{"range":{"date_created":{"gte":"2018-01-01","format":"yyyy-MM-dd"}}},{"range":{"date_created":{"lte":"2018-12-12","format":"yyyy-MM-dd"}}}]}}]}},"_source":["*","created_by"],"aggs":{"groupdata":{"terms":{"field":"created_by.keyword","size":10000},"aggs":{"value":{"sum":{"field":"amount"}}}}},"explain":true},"_source":["*","created_by"],"from":0,"size":10000}';
