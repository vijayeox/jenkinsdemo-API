...
class CommentService extends AbstractService
{
    ...
    */
    ...
    {
        $query = "select text,ou.name as name,ou.icon as icon,ou.uuid as userId,ox_comment.date_created as time from ox_comment inner join ox_user ou on ou.id = ox_comment.created_by where ox_comment.org_id = :orgId AND ox_comment.file_id = :fileId order by ox_comment.created_by desc";
