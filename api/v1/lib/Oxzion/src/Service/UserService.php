...
class UserService extends AbstractService
{
    ...
    public function __construct($config, $dbAdapter, UserTable $table = null, AddressService $addressService, EmailService $emailService, TemplateService $templateService, MessageProducer $messageProducer,UserProfileService $userProfile, EmployeeService $empService)
    {
