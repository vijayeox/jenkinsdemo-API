...
// TODO: Additional Insured - Difference cannot be found. fileAttribute ->index column
    ...
    public function getFileList($appUUid, $params, $filterParams = null)
    {
        ...
        try {
            $select = "SELECT DISTINCT SQL_CALC_FOUND_ROWS of.data, of.id as myId, of.account_id,of.rygStatus as rygStatus,of.uuid,of.version as version,  wi.status, wi.process_instance_id as workflowInstanceId,of.date_created,en.name as entity_name,en.uuid as entity_id,oa.name as appName $field $fromQuery $where $sort $pageSize $offset";
