...
chmod 777 -R .
composer install
php ./bin/console oro:install --env=prod --timeout=30000 --application-url="http://172.16.1.75:8075/crm/public" --organization-name="Vantage Agora" --user-name="admin" --user-email="admin@example.com" --user-firstname="Admin" --user-lastname="User" --user-password="admin" --language=en --formatting-code=en_US
