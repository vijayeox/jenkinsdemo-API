...
class CCandICPDFGenerationTest extends DelegateTest
{
    ...
    public function testCCandICPDFGeneration()
    {
        ...
        'companyName' => 'abcd',
        'personalInforFirstName' => 'testuser',
        'orgUuid' => '5060e4d5-006a-4054-85c0-bbf78579412d',
        'appId' => 'a4b1f073-fc20-477f-a804-1aa206938c42',
        'accountId' => '5060e4d5-006a-4054-85c0-bbf78579412d'];
        ...
        $destination = $config['APP_DOCUMENT_FOLDER'].$data['orgUuid']."/CC.pdf";
        ...
        FileUtils::deleteFile("CC.pdf", $config['APP_DOCUMENT_FOLDER'].$data['orgUuid']."/");
