...
<body>
    ...
    <div id="inline">
        <p class="p1 ft1">SECTION 1</p>
        <p class="p2 ft2">GENERAL INFORMATION</p>
    </div>
    <div id="sectionContent">
        <p>
            ...
            <strong>Desired Policy Effective Date: </strong><span class="underline">{$desiredPolicyEffectiveDate}</span>
            <br>
        ...
        <p>
            ...
            {if $excessAutoLiability == true || $excessAutoLiability == "true"}
                <input id="Excess Auto Liability Only" type="checkbox" name="Excess Auto Liability Only" checked readonly />
        ...
        <p>
            <strong>Target Premium: </strong><span class="underline">{$targetPremium}</span>
        </p>
        <table>
            <tr>
            ...
            <tr>
                <td>
                    {if $commercialAutoLiability == true || $commercialAutoLiability == "true"}
                        <input id="Excess Auto Liability" type="checkbox" name="Excess Auto Liability" checked readonly />
            ...
            <tr>
                <td>
                    {if $personalInjuryProtectionPip == true || $personalInjuryProtectionPip == "true"}
                        <input id="Personal Injury Protection (PIP)" type="checkbox" name="Personal Injury Protection (PIP)"
                            checked readonly />
        ...
        {/if}
        <p>SECTION 1: GENERAL INFORMATION, continued</p>
        <p>
    ...
    <p></p>
    <div id="inline">
        <p class="p1 ft1">SECTION 2</p>
        <p class="p2 ft2">DRIVER INFORMATION</p>
    </div>
    <div id="sectionContent">
        ...
        <p>SECTION 2: DRIVER INFROMATION, continued</p>
                ...
                {if isset($survey2['areOwnerOperatorDriversSubjectToTheSameDriverTrainingAsCompanyDrivers'])}
                    <td>
                        {if $survey2.areOwnerOperatorDriversSubjectToTheSameDriverTrainingAsCompanyDrivers == "yes"}
                            <input id="areOwnerOperatorDriversSubjectToTheSameDriverTrainingAsCompanyDrivers" type="checkbox"
                                name="areOwnerOperatorDriversSubjectToTheSameDriverTrainingAsCompanyDrivers" checked readonly />
            ...
            <tr>
                ...
                {if isset($survey2['areTripLeaseAgreementsUsed'])}
                    <td>
                        ...
                        {else}
                            <input id="areTripLeaseAgreementsUsed" type="checkbox" name="areTripLeaseAgreementsUsed" readonly />
                            <label for="areTripLeaseAgreementsUsed">Y</label>
                        {/if}
                    </td>
                    <td>
                ...
                {if isset($survey2['isEquipmentInspectedByTheInsured'])}
                    <td>
                        {if $survey2.isEquipmentInspectedByTheInsured == "yes"}
                            <input id="isEquipmentInspectedByTheInsured" type="checkbox" name="isEquipmentInspectedByTheInsured"
                                checked readonly />
                    ...
                    <td>
                        {if $survey2.areAllOwnerOperatorsRequiredToCarryAtLeast500000NonTruckingLiability == "yes"}
                            <input id="areAllOwnerOperatorsRequiredToCarryAtLeast500000NonTruckingLiability" type="checkbox"
                                name="areAllOwnerOperatorsRequiredToCarryAtLeast500000NonTruckingLiability" checked readonly />
                ...
                {if isset($survey2['areCertificatesOnFile'])}
                    <td>
                        {if $survey2.areCertificatesOnFile == "yes"}
                            <input id="areCertificatesOnFile" type="checkbox" name="areCertificatesOnFile" checked readonly />
    ...
    <div id="inline">
        <p class="p1 ft1">SECTION 3</p>
        <p class="p2 ft2">DRIVER HIRING</p>
    </div>
    <div id="sectionContent">
            ...
            {if isset($survey3['doYouOrderMvRsPriorToHiring'])}
                <td>
                    {if $survey3.doYouOrderMvRsPriorToHiring == "yes"}
                        <input id="doYouOrderMvRsPriorToHiring" type="checkbox" name="doYouOrderMvRsPriorToHiring" checked
                            readonly />
                        <label for="doYouOrderMvRsPriorToHiring">Y</label>
                    {else}
                        <input id="doYouOrderMvRsPriorToHiring" type="checkbox" name="doYouOrderMvRsPriorToHiring" readonly />
                        <label for="doYouOrderMvRsPriorToHiring">Y</label>
                    {/if}
                </td>
                <td>
    ...
    <div id="inline">
        <p class="p1 ft1">SECTION 4</p>
        <p class="p2 ft2">MAINTENANCE PROGRAM</p>
    </div>
    <div id="sectionContent">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    {if isset($controlledInspectionReports) && $controlledInspectionReports == true}
                        <input id="controlledInspectionReports" type="checkbox" name="controlledInspectionReports" checked
                            readonly />
    ...
    <div id="inline">
        <p class="p1 ft1">SECTION 5</p>
        <p class="p2 ft2">SAFETY</p>
    </div>
    <div id="sectionContent">
            ...
            <tr>
                ...
                {if isset($survey5['areSafetyMeetingsMandatory'])}
                    <td>
                        ...
                        {else}
                            <input id="areSafetyMeetingsMandatory" type="checkbox" name="areSafetyMeetingsMandatory" readonly />
                            <label for="areSafetyMeetingsMandatory">Y</label>
                        {/if}
                    </td>
                    <td>
    ...
    <div id="sectionContent">
                ...
                {if isset($survey6['doesApplicantDoAnyRigging'])}
                    <td>
                        {if $survey6.doesApplicantDoAnyRigging == "yes"}
                            <input id="doesApplicantDoAnyRigging" type="checkbox"
                                name="doesApplicantDoAnyRigging" checked readonly />
                            <label for="doesApplicantDoAnyRigging">Y</label>
                        {else}
                            <input id="doesApplicantDoAnyRigging" type="checkbox"
                                name="doesApplicantDoAnyRigging" readonly />
                            <label for="doesApplicantDoAnyRigging">Y</label>
                        {/if}
                    </td>
                    <td>
        ...
        <p>SECTION 6: GENERAL LIABILITY, continued</p>
