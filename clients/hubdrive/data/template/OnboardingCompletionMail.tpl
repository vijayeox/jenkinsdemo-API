...
<html>
    ...
    <body>
        <span class="preheader">Onboarding Completion</span>
        <table
        role="presentation"
        border="0"
        cellpadding="0"
            ...
            <div class="content">
                ...
                <tr>
                    ...
                    >
                        ...
                        <td>
                            <p>Hello,</p>
                            <p>This is an automated email to notify that {$personalInfoFirstName}{$personalInfoLastName} has completed the On-Boarding process.the attached documents are for your review.</p>
                            <p>Thank you</p>
                            <br />
                            <br />
                        </td>
