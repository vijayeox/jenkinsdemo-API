...
class InsureLearnInsured extends AbstractAppDelegate
{
    use InsuranceTrait;
    ...
    public function execute(array $data, Persistence $persistenceService)
    {
        ...
        $this->checkProducerManager($data['produceruuid'], $contractorGroup['group']);
        $this->checkManager($data, $contractorGroup['group']);
        $this->logger->info("HERE DRIVER INSURE LEARN ADDEDD");
        return $data;
    }
    private function checkProducerManager($produceruuid,$group){
        $data = $userDataIfExists = $this->userService->getUserInfoByUuid($produceruuid);
        //print_r($userDataIfExists);die;
