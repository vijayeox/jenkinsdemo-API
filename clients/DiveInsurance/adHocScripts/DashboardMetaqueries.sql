...
INSERT INTO ox_widget (uuid,visualization_id,ispublic,created_by,date_created,org_id,isdeleted,name,configuration,version,expression) VALUES ('d2434992-e6a4-4fc6-9dde-d35e4da58b19',(SELECT id from ox_visualization where name like 'Calculated value'),1,(SELECT id from ox_user where username like 'testhub07.gmail.com'),'2019-12-13 17:00:04',(SELECT id from ox_organization where name LIKE 'Vincencia & Buckley'),0,'Hub Submissions','{"numberFormat":" "}',1,'');
...
INSERT INTO ox_widget (uuid,visualization_id,ispublic,created_by,date_created,org_id,isdeleted,name,configuration,version,expression) VALUES ('744fde28-e273-4042-bb92-5aa7f6d3554b',(SELECT id from ox_visualization where name like 'Calculated value'),1,(SELECT id from ox_user where username like 'testhub07.gmail.com'),'2019-12-13 17:00:04',(SELECT id from ox_organization where name LIKE 'Vincencia & Buckley'),0,'Hub Policies','{"numberFormat":" "}',1,'');
...
INSERT INTO ox_widget (uuid,visualization_id,ispublic,created_by,date_created,org_id,isdeleted,name,configuration,version,expression) VALUES ('1f8fc873-b729-41b6-9c2f-bed07db8f70a',(SELECT id from ox_visualization where name like 'Calculated value'),1,(SELECT id from ox_user where username like 'testhub07.gmail.com'),'2019-12-13 17:00:04',(SELECT id from ox_organization where name LIKE 'Vincencia & Buckley'),0,'Hub Written Premium','{"numberFormat":"$ 0.00 a"}',1,'');
