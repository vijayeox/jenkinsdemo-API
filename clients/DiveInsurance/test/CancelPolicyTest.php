...
class CancelPolicyTest extends DelegateTest
{
    ...
    public function testPolicyDocumentDiveBoatSold()
    {
        ...
        $data = [
                 ...
                 'fileId' => '0c8ea15f-d5e4-4a2d-9290-d2005cadc487',
                 'firstname' => 'Mohan',
                 'initial' => 'Raj' ,
                 'lastname' => 'D',
                 'address1' => 'ABC 200',
                 ...
                 'liability_carrier' => "Tokio",
                 "liability_policy_id" => "12345"
                ];
        $config = $this->getApplicationConfig();
        ...
        $this->assertEquals(isset($content['liability_carrier']), true);
        $this->assertEquals(isset($content['liability_policy_id']), true);
        ...
        FileUtils::rmDir($config['APP_DOCUMENT_FOLDER'].$this->data['orgUuid'].'/'.$content['uuid'].'/'."*");
    }
    public function testPolicyDocumentDiveStoreSold()
    {
        ...
        $data = [
                 ...
                 'cancellationStatus' => 'approved',
                 'business_name' => 'Dive Boat',
                 'liability_carrier' => "Tokio",
                 "liability_policy_id" => "12345",
                 "propertyCoverageSelect" => "no",
                 "groupProfessionalLiabilitySelect" => "no"
                ];
        $config = $this->getApplicationConfig();
        $delegateService = $this->getApplicationServiceLocator()->get(AppDelegateService::class);
        $delegateService->setPersistence($appId, $this->persistence);
