...
UPDATE `carrier_policy` SET `policy_number` = 'Binder' WHERE `product` = 'Individual Professional Liability' AND `state` = 'Guam';
...
INSERT INTO `carrier_policy` (`product`,`carrier`,`policy_number`,`state`,`start_date`,`end_date`,`year`) VALUES ('Individual Professional Liability', 'Tokio Marine Specialty Insurance Company', 'Binder','Guam',"2020-06-30 00:00:00","2021-06-30 11:59:59",2020); 
