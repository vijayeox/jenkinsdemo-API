{* Group Professional Liability Policy *}
            ...
            <div style='line-height: 24px'>Dear {$lastname}, {$firstname}{if isset($initial)}, {$initial}{/if}, <br/>
                <p>Attached are your PADI Endorsed Insurance Documents for your group professional liability policy. Please review carefully and advise of any changes needed.
				</p>
			 <br/>
			 <br/>
