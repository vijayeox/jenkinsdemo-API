{* Dive Store Renewal Policy *}
            ...
            <div style='line-height: 24px'>Dear {$lastname}, {$firstname}{if isset($initial)}, {$initial}{/if}, <br/>
				...
				<p>A formal proposal will be emailed to you after all required information is received.</p><br/>

				<p>PLEASE REPLY TO THIS EMAIL BY MAY 10, {$expiry_year}.</p>

				<p>Thank you for your prompt attention to this matter, and please call me if you need any assistance.
				</p>
			 <br/>
