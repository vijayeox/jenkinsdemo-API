    	...
    	<div class="i_type">
      		<div class="i_type1">
	        	...
	        	<div class = "in-type1"> 
		            <p class = "ins_type"  style="margin-bottom: 10px;margin-left:1px;">Professional Liability - Claims Made Form</p>
			            <p class = "ins_font">Insured's Status: {$careerCoverageVal} {if $scubaFit != "scubaFitInstructorDeclined"} <span> and {$scubaFitVal} </span>{/if}</p>
	     	...
	     	<div class="i_type2">
		       ...
		       <div class="right2" style="margin-top: 9px;">
		          <p class = "ins_font">&nbsp</p>
		          <p class = "ins_font">{if $equipment != "equipmentLiabilityCoverageDeclined"}
		          			Included
		          		{else}
		          			Not Included
		          		{/if}</p>
		          <p class = "ins_font">{if $cylinder != "cylinderInspectorOrInstructorDeclined"}
		          			{$cylinderPriceVal}
		          		{else}
		          			Not Covered
		          		{/if}
