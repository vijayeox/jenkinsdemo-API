 {assign var=year value={'Y'|date}}
  {* Dive Boat COI Auto Renewal Notification Template *}
            ...
            <div style='line-height: 24px'>Dear {$lastname}, {$firstname}{if isset($initial)}, {$initial}{/if}, <br/><br/>
				...
				<br/>
				<p>It's that time of the year to think about insurance. Fortunately, you are currently signed up for automatic renewal under the Dive Boat Program.</p><br/>
