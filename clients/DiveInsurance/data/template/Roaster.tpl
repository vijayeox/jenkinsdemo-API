	...
	<div class ="body_div_lp">
			...
			<table>
				<tr>
					...
					<th class = 'r_headerRow'>PADI Number&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
	    		...
	    		<tr>
	    			<td>{$additional.initial} {$additional.firstname} {$additional.lastname}</td>
