...
<script>
  function subst() {
      ...
      var css_selector_classes = ['page', 'frompage', 'topage', 'webpage', 'section', 'subsection', 'date', 'isodate', 'time', 'title', 'doctitle', 'sitepage', 'sitepages','start_date','license_number','firstname','lastname','city','state','country','zipcode','certificate_no','padi','end_date','policy_id','address1','address2'];
 ...
 <div class = "main_div1">
    ...
    <div class = "cont">
      <div class ="content1">
          ...
          <p class = "details"><span class ="orgname"></span></p>
          <p class = "details"><span class ="address1"></span></p>
          <p class = "details"><span class ="address2"></span></p>
          <p class = "details"><span class ="city"></span>,<span class ="state"></span></p>
          <p class = "details"><span class ="country"></span>,<span class ="zipcode"></span></p>
      </div>
      <div class ="content2">
        ...
        <div class = "certificate1">
          ...
          <p class = "p_margin"><span class ="padi"></p>
