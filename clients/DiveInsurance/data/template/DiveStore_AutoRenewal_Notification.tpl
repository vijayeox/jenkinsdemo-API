 {assign var=year value={'Y'|date}}
  {* Dive Store COI Auto Renewal Notification Template *}
            ...
            <div style='line-height: 24px'>Dear {$firstname} {$lastname}, <br/><br/>
				...
				<br/>
				<p>It's that time of the year to think about insurance. Fortunately, you are currently signed up for automatic renewal under the Dive Store Program.</p><br/>
