...
<body>
	<div class ="div_cover">
		...
		<p>Enclosed is the endorsement to your PADI Endorsed {if $product == 'Group Professional Liability'} Professional Liability {else} Dive Center {/if}policy.{if isset($notes) && $notes != ""}  This endorsement makes the following change:</p>
		<p>{$notes}</p>
		{/if}
