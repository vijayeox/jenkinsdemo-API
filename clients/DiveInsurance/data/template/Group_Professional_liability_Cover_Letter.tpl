...
<body>
	<div class ="div_cover">
		...
		<div class ="info_cover">
			...
			{if(isset($dba) && $dba != "")}<p class="name">{$dba}</p>{/if}
		...
		<p class = "rgard">RE: PADI SPONSORED GROUP PROFESSIONAL LIABILITY INSURANCE</p>
		...
		<ul class ="order">
			...
			<li>Please be sure your roster is up to date, including anyone no
longer working for you.</li>
		...
		<p class = "line_end">Thank you for your support of the PADI endorsed Group Professional liability insurance program. Please call or email me if you have any
questions.</p>
</div>
		<p>Sincerely,</p>
