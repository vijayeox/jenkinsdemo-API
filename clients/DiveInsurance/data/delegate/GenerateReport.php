    ...
    private function newDataArray($data,$product){
		...
		if((int)$value['totalAmount'] > 0){
                ...
                if($product == "diveStoreProperty"){
                    $responsePrimary[$i]['propertyDeductables'] = ($value['workflow_name'] == "DS Cancel Policy" || $value['workflow_name'] == "Dive Store Reinstate Policy") ? 0 : (($value['propertyDeductibles'] == "propertyDeductibles1000") ? "$1,000" : (($value['propertyDeductibles'] == "propertyDeductibles2500") ? "$2,500" : (($value['propertyDeductibles'] == "propertyDeductibles5000")? "$5,000" : "$1,000")));
