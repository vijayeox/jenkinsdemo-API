			...
			foreach ($additionalLocationData as $key2 => $value2) { 
                    ...
                    if(isset($previous_additionalLocation)){
                        ...
                        if($product == "diveStore"){
                            ...
                            $response[$i][$j]['ProRata_basepremium'] = ($value['workflow_name'] == "DS Cancel Policy" || $value['workflow_name'] == "Dive Store Reinstate Policy") ? 0 : ($value['workflow_name'] == "Dive Store Endorsement" ? (isset($value2['ALCoverageFP']) ? round((float)$value2['ALCoverageFP'] * (float)($value2['ALProRataPremiumPercentage'])) : "0.00") : round((float)$value2['ALCoverageFP'] * (float)($value2['ALProRataPremiumPercentage'])));
                            $response[$i][$j]['ProRata_nonDivingPool'] = ($value['workflow_name'] == "DS Cancel Policy" || $value['workflow_name'] == "Dive Store Reinstate Policy") ? 0 : ($value['workflow_name'] == "Dive Store Endorsement" ? (isset($value2['ALnonDivingPoolAmount']) ? round((float)$value2['ALnonDivingPoolAmount'] * (float)($value2['ALProRataPremiumPercentage'])) : "0.00") : round((float)$value2['ALnonDivingPoolAmount'] * (float)($value2['ALProRataPremiumPercentage'])));
                            $response[$i][$j]['ProRata_ExcessLiability'] = ($value['workflow_name'] == "DS Cancel Policy" || $value['workflow_name'] == "Dive Store Reinstate Policy") ? 0 : ($value['workflow_name'] == "Dive Store Endorsement" ? (isset($value2['ALExcessLiabilityFP']) ? round((float)$value2['ALExcessLiabilityFP'] * (float)($value2['ALProRataPremiumPercentage'])) : "0.00") : round((float)$value2['ALExcessLiabilityFP'] * (float)($value2['ALProRataPremiumPercentage'])));
                            $response[$i][$j]['ProRata_TravelAgent'] = ($value['workflow_name'] == "DS Cancel Policy" || $value['workflow_name'] == "Dive Store Reinstate Policy") ? 0 : ($value['workflow_name'] == "Dive Store Endorsement" ? (isset($value2['ALTravelAgentEOFP']) ? round((float)$value2['ALTravelAgentEOFP'] * (float)($value2['ALProRataPremiumPercentage'])) : "0.00") : round((float)$value2['ALTravelAgentEOFP'] * (float)($value2['ALProRataPremiumPercentage'])));
                            $response[$i][$j]['ProRata_medicalExpense'] = ($value['workflow_name'] == "DS Cancel Policy" || $value['workflow_name'] == "Dive Store Reinstate Policy") ? 0 : ($value['workflow_name'] == "Dive Store Endorsement" ? (isset($value2['ALMedicalExpenseFP']) ? round((float)$value2['ALMedicalExpenseFP'] * (float)($value2['ALProRataPremiumPercentage'])) : "0.00") : round((float)$value2['ALMedicalExpenseFP'] * (float)($value2['ALProRataPremiumPercentage'])));
                            $response[$i][$j]['ProRata_nonOwnedAuto'] = ($value['workflow_name'] == "DS Cancel Policy" || $value['workflow_name'] == "Dive Store Reinstate Policy") ? 0 : ($value['workflow_name'] == "Dive Store Endorsement" ? (isset($value2['ALNonOwnedAutoFP']) ? round((float)$value2['ALNonOwnedAutoFP'] * (float)($value2['ALProRataPremiumPercentage'])) : "0.00") : round((float)$value2['Non-ALNonOwnedAutoFP'] * (float)($value2['ALProRataPremiumPercentage'])));
