...
class DiveBoatEndorsementRatecard extends AbstractAppDelegate
{
    ...
    {  
        ...
        $select = "Select * FROM premium_rate_card WHERE product ='".$data['product']."' AND start_date <= '".$data['start_date']."' AND is_upgrade = 1 AND end_date >= '".$data['start_date']."'";
