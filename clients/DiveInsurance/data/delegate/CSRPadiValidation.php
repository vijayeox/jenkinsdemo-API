...
class CSRPadiValidation extends AbstractAppDelegate
{
  ...
  public function execute(array $data, Persistence $persistenceService)
  {
    ...
    $select =
      "Select firstname, MI as initial, lastname, email, address1, address2, city, state, country_code, zip, home_phone, work_phone, num as mobilephone FROM padi_data WHERE member_number ='" .
      $data['member_number'] .
      "'";
