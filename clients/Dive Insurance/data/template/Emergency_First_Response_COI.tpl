	...
	<div class ="body_div">
		...
		<div class = "content">
			<div class ="content1">
					...
					<div class = "caption1">
						<p class ="info_efr">Vicencia & Buckley A Division of HUB International Insurance Services</p>
						<p class ="info_efr1">6 Centerpointe Drive, #350 La Palma, CA 90623-2538</p>
			...
			<div class ="content2">
				...
				<p class = "efr_title"><b>Named Insured</b></p>
					...
					<p class ="efr_title2">{$city},{$state},{$country},{$zipcode}</p>
			</div>
		</div>
      		...
      		<div class="i_type1">
	        	...
	        	<div class = "in-type1"> 
		            <p class = "ins_type"  style="margin-bottom: 10px;margin-left:1px;">Professional Liability</p>
			            <p class = "ins_font">${$single_limit}&nbsp&nbsp&nbsp(per accident)</p>
